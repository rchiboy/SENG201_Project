...
public class GameEnvironment {
	...
	private Crew crew = new Crew("TestName");
...
//	}
	...
	*/
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("Pick 2-4 member for your Crew");
		Scanner input1 = new Scanner(System.in);
		String temp = input1.nextLine();
		System.out.println("What is the name of this member?");
		Scanner input2 = new Scanner(System.in);
		String temp2 = input2.nextLine();

		if (game.getTypes().contains(temp)) {
			game.addMember(temp2, temp);
		}
		
		System.out.println(game.getCrew().getMembers().get(0).viewHealth());
